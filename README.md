...
The online deployment of this project is available at [Todo App](#).

## Getting Started

To get started, you can clone the repository and install the dependencies in the root folder:
